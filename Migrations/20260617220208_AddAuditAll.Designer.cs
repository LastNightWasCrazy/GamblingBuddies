...
namespace GamblingBuddies.Migrations
{
    ...
    [Migration("20260617220208_AddAuditAll")]
    partial class AddAuditAll
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GamblingBuddies.Models.Payment", b =>
                {
                    ...
                    b.ToTable("Payments", null, t =>
                        {
                            t.HasTrigger("trg_Archive_PaidPayments");
                        });
            ...
            modelBuilder.Entity("GamblingBuddies.Models.RegistrationRequest", b =>
                {
                    ...
                    b.ToTable("RegistrationRequests", null, t =>
                        {
                            t.HasTrigger("trg_RegistrationRequest_StatusHistory");
                        });
            ...
            modelBuilder.Entity("GamblingBuddies.Models.SystemUser", b =>
                {
                    ...
                    b.ToTable("SystemUsers", null, t =>
                        {
                            t.HasTrigger("trg_SystemUsers_Audit");
                        });
